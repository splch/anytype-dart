...
class ErrorCodes extends $pb.ProtobufEnum {
  ...
  static const ErrorCodes GetTreeError =
      ErrorCodes._(1, _omitEnumNames ? '' : 'GetTreeError');
  static const ErrorCodes FullSyncRequestError =
      ErrorCodes._(2, _omitEnumNames ? '' : 'FullSyncRequestError');
  static const ErrorCodes ErrorOffset =
      ErrorCodes._(400, _omitEnumNames ? '' : 'ErrorOffset');

  static const $core.List<ErrorCodes> values = <ErrorCodes>[
    Unexpected,
    GetTreeError,
    FullSyncRequestError,
    ErrorOffset,
  ];
